...
namespace ULA.Devices.PICONGS.Presentation.Views
{
    ...
    /// </summary>
    public partial class PICONGSConfigurationModeView
    {
        /// <summary>
        ...
        public PICONGSConfigurationModeView(IIoCContainer container)
        {
            InitializeComponent();
            IConfigurationModeViewModel viewModel =
                container.Resolve<IConfigurationModeViewModel>(ApplicationGlobalNames.PICONGS_CONFIGURATION_VIEWMODEL_NAME);
        ...
        {
            var vm = this.DataContext as PICONGSConfigurationModeViewModel;
