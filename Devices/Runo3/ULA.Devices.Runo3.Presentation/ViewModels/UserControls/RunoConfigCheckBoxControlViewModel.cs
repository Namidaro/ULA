...
namespace ULA.Devices.Runo3.Presentation.ViewModels.UserControls
{
    /// <summary>
    ///     Представляет вью-модель для контрола с чекбоксами(Будет использоваться в конфигурации
    ///     устройства)
    /// </summary>
    public class RunoConfigCheckBoxControlViewModel : ViewModelBase, IConfigCheckBoxControlViewModel
    {
        ...
        ///     Конструктор
        /// </summary>
        public RunoConfigCheckBoxControlViewModel()
        {
            this._checkBoxCount = 16;
