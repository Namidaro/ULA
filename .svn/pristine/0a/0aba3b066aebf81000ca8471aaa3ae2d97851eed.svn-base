...
namespace YP.Toolkit.System.ParallelExtensions
{
    public static partial class TaskFactoryExtensions
    {
        ...
        /// <param name="source">The enumerable containing the tasks to be iterated through.</param>
        /// <returns>A Task that represents the complete asynchronous operation.</returns>
        public static Task<TResult> IterateWithResult<TResult>(
            this TaskFactory factory,
            IEnumerable<Task> source)
        {
            if (factory == null) throw new ArgumentNullException("factory");
            return IterateWithResult<TResult>(factory, source, null, factory.CancellationToken, factory.CreationOptions, factory.GetTargetScheduler());
        }
        /// <summary>
        /// Asynchronously iterates through an enumerable of tasks.
        /// </summary>
        ...
        {
            if (factory == null) throw new ArgumentNullException("factory");
            return IterateWithResult<TResult>(factory, source, null, cancellationToken, factory.CreationOptions, factory.GetTargetScheduler());
        }
        /// <summary>
        /// Asynchronously iterates through an enumerable of tasks.
        /// </summary>
        ...
        {
            if (factory == null) throw new ArgumentNullException("factory");
            return IterateWithResult<TResult>(factory, source, null, factory.CancellationToken, creationOptions, factory.GetTargetScheduler());
        }
        /// <summary>
        /// Asynchronously iterates through an enumerable of tasks.
        /// </summary>
        ...
        {
            if (factory == null) throw new ArgumentNullException("factory");
            return IterateWithResult<TResult>(factory, source, null, factory.CancellationToken, factory.CreationOptions, scheduler);
        }
        /// <summary>
        /// Asynchronously iterates through an enumerable of tasks.
        /// </summary>
        ...
        public static Task<TResult> IterateWithResult<TResult>(
            ...
            CancellationToken cancellationToken, TaskCreationOptions creationOptions, TaskScheduler scheduler)
        {
            return IterateWithResult<TResult>(factory, source, null, cancellationToken, creationOptions, scheduler);
        }
        ...
        public static Task Iterate(
            this TaskFactory factory,
            IEnumerable<Task> source, object state)
        {
            if (factory == null) throw new ArgumentNullException("factory");
            ...
            recursiveBody = antecedent =>
            {
                try
                {
                    ...
                    if (enumerator.MoveNext())
                    {
                        ...
                        {
                            var nextTask = task;
                            //nextTask.IgnoreExceptions();TODO: Look in the future, how this method will work
                            if (recursiveBody != null)
                                nextTask.ContinueWith(recursiveBody);//.IgnoreExceptions();TODO: Look in the future, how this method will work
                        }
        ...
        {
            if (factory == null) throw new ArgumentNullException("factory");
            return IterateWithResult<TResult>(factory, source, state, factory.CancellationToken, factory.CreationOptions, factory.GetTargetScheduler());
        }
        /// <summary>
        /// Asynchronously iterates through an enumerable of tasks.
        /// </summary>
        ...
        {
            if (factory == null) throw new ArgumentNullException("factory");
            return IterateWithResult<TResult>(factory, source, state, cancellationToken, factory.CreationOptions, factory.GetTargetScheduler());
        }
        /// <summary>
        /// Asynchronously iterates through an enumerable of tasks.
        /// </summary>
        ...
        {
            if (factory == null) throw new ArgumentNullException("factory");
            return IterateWithResult<TResult>(factory, source, state, factory.CancellationToken, creationOptions, factory.GetTargetScheduler());
        }
        /// <summary>
        /// Asynchronously iterates through an enumerable of tasks.
        /// </summary>
        ...
        {
            if (factory == null) throw new ArgumentNullException("factory");
            return IterateWithResult<TResult>(factory, source, state, factory.CancellationToken, factory.CreationOptions, scheduler);
        }
        /// <summary>
        /// Asynchronously iterates through an enumerable of tasks.
        /// </summary>
            ...
            CancellationToken cancellationToken, TaskCreationOptions creationOptions, TaskScheduler scheduler)
        {
            ...
            recursiveBody = antecedent =>
            {
                try
                {
                    ...
                    {
                        var lastTask = antecedent as Task<TResult>;
                        trs.SetResult(lastTask == null ? default(TResult) : lastTask.Result);
                    }
                }
                // If MoveNext throws an exception, propagate that to the user,
                // either as cancellation or as a fault
