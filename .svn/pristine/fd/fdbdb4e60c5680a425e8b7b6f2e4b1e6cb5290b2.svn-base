...
namespace ULA.Common.Formatters
{
    ...
    /// </summary>
    [DataContract(Name = "bytesToIntCurrentFormatter")]
    public class BytesToIntCurrentFormatter : BinaryFormatterBase
    {
        ...
        /// </summary>
        private BytesToIntCurrentFormatter()
        {
        }
        ...
        public BytesToIntCurrentFormatter(int index, int bitNumber = -1)
        {
            this._index = index;
        ...
        protected override byte[] OnFormatBack(object currentValue, byte[] value)
        {
            ...
            var persistanceValue = (int)(intValue * 65535 / 100); //эти числа мне сказали конструкторы
        ...
        protected override object OnFormat(byte[] value)
        {
            ...
            return (((double)value[this._index - 1] * 256 + value[this._index]) * 100 / 65535); //эти числа мне сказали конструкторы
        }
