...
namespace ULA.Common.Formatters
{
    ...
    /// </summary>
    [DataContract(Name = "bytesToIntVoltageFormatter")]
    public class BytesToIntVoltageFormatter : BinaryFormatterBase
    {
        ...
        /// </summary>
        private BytesToIntVoltageFormatter()
        {
        }
        ...
        public BytesToIntVoltageFormatter(int index, int bitNumber = -1)
        {
            this._index = index;
        ...
        protected override object OnFormat(byte[] value)
        {
            ...
            return (((double)value[this._index - 1] * 256 + value[this._index]) * 400 / 65535); //эти числа мне сказали конструкторы
        }
