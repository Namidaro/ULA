...
namespace YP.Toolkit.System.ParallelExtensions
{
    ...
    public static class LinqToTasks
    {
            ...
            Func<TSource, TCollection, TResult> resultSelector)
        {
            ...
            return source.ContinueWith(t => collectionSelector(t.Result).
                                                ContinueWith(c => resultSelector(t.Result, c.Result), TaskContinuationOptions.NotOnCanceled), TaskContinuationOptions.NotOnCanceled).Unwrap();
        }
