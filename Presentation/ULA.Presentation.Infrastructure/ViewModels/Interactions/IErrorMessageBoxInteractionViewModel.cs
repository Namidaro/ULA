...
{
    /// <summary>
    ///     Exposes system ErrorMessageBox interaction view model functionality
    /// </summary>
    public interface IErrorMessageBoxInteractionViewModel : IInteractionViewModel
    {
        /// <summary>
        ...
        /// <summary>
        ///     Gets a type byttons for interaction with user
        /// </summary>
        MessageBoxButtonType ButtonType { get; set; }
    }
}