namespace ULA.Presentation.Infrastructure
{
    ...
    public static class ApplicationGlobalNames
    {
        ...
        /// 
        /// </summary>
        public const string COMMAND_ON_TEMPLATES_VIEW_NAME = "CommandOnTemplatesView";
        ...
        ///     Gets the name of the system busy interaction request provider
        /// </summary>
        public const string EXTRASETTINGS_INTERACTION_PROVIDER_NAME = "ExtraSettingsInteractionProvider";

        /// <summary>
        ///     Gets the name of the system error messagebox interaction request provider
        /// </summary>
        public const string ERROR_MESSAGEBOX_INTERACTION_PROVIDER_NAME = "ErrorMessageBoxInteractionProvider";
        ...
        ///     Gets the name of the citywide commands interaction request provider
        /// </summary>
        public const string COMMAND_ON_TEMPLATES_INTERACTION_PROVIDER_NAME =
            "CommandOnTemplatesInteractionProvider";
        ...
        /// </summary>
        public const string SYNCHRONIZATION_TIME_PROVIDER_NAME = "SynchronizationTimeInteractionProvider";
        ...
        /// </summary>
        public const string CONFIGURATION_MODE_VIEW_MODEL_NAME = "ConfigurationModeViewModel";

        /// <summary>
        ///     Gets the name of the application busy dialog view
        /// </summary>
        public const string BUSY_INTERACTION_VIEW_NAME = "BusyIneractionView";


        /// <summary>
        ///     Gets the name of the application busy dialog view
        /// </summary>
        public const string EXTRASETTINGS_INTERACTION_VIEW_NAME = "ExtraSettingsIneractionView";
        ...
        /// </summary>
        public const string INFORMATION_MESSAGEBOX_VIEW_NAME = "InformationMessageBoxInteractionView";
        ...
        /// </summary>
        public const string LIST_WIDGET_CONFIGURATION_VIEW_NAME = "ListWidgetModeConfigurationView";
        ...
        ///     Gets the name of the scheme view in runtime mode
        /// </summary>
        public const string CURRENT_DEVICE_VIEW_MODEL = "CurrentdDeviceViewModel";
        ...
        /// </summary>
        public const string CONFIGURATION_VIEW_NAME = "ConfigurationViewName";

        /// <summary>
        ///     Gets the name of the confugurate runo viewmodel name
        /// </summary>
        public const string RUNO_CONFIGURATION_VIEWMODEL_NAME = "RunoConfigurationModeViewModel";
        ...
        ///     Gets the name of the lighting shedule view name
        /// </summary>
        public const string PICON2LIGHTING_SHEDULER_VIEW_NAME = "Picon2LightingSheduleView";


        /// <summary>
        ///     Gets the name of the picon2 module info
        /// </summary>
        public const string PICON2_MODULE_INFO_VIEW_NAME = "Picon2ModuleInfoView";



        /// <summary>
        ///     Gets the name of the lighting shedule viewmodel name
        /// </summary>
        public const string LIGHTING_SHEDULER_VIEWMODEL_NAME = "LightingSheduleViewModel";

        /// <summary>
        ///     Gets the name of the lighting shedule view name
        /// </summary>
        public const string PICON2LIGHTING_SHEDULER_VIEWMODEL_NAME = "Picon2LightingSheduleViewModel";
       ...
       /// <summary>
        ///     Get the name PICONGS configuration view
        /// </summary>
        public const string PICONGS_CONFIGURATION_VIEW_NAME = "PICONGSConfigurationModeView";


        /// <summary>
        ///     Get the name PICONGS configuration viewmodel
        /// </summary>
        public const string PICONGS_CONFIGURATION_VIEWMODEL_NAME = "PICONGSConfigurationModeViewModel";

     /// <summary>
        ///     Get the name PICON2 configuration view
        /// </summary>
        public const string PICON2_CONFIGURATION_VIEW_NAME = "PICON2ConfigurationModeView";

   /// <summary>
        ///     Get the name PICON2 configuration viewmodel
        /// </summary>
        public const string PICON2_CONFIGURATION_VIEWMODEL_NAME = "PICON2ConfigurationModeViewModel";
